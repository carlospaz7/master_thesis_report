...
-The world is moving towards an automated teaching world, automated means that no human interaction is needed to produce learning material.
-Even further with the abundance of content in foreign languages, it is possible to find content in the interest of the learner.
-How do we measure that the student is learning what he is studying? A standardized exam (TOEFL, IELTS) provides a common framework for evaluating the knowledge of all students, no matter where do they study from. Now the question is, "is it possible to acquire the desired level of knowledge by studying material of my own interest?" In order to answer the question we need to 
